...
public class PopularWallpapersFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public PopularWallpapersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.popular_wallpapers_fragment, container, false);
...
//        mSwipeRefreshLayout.setColorSchemeResources(R.color.colorPrimary,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                unsplash.getPhotos(pageNo, 30, Order.POPULAR, new Unsplash.OnPhotosLoadedListener() {
                    @Override
