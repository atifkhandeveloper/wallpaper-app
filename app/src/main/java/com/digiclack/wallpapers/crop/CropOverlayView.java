...
public class CropOverlayView extends View {
    ...
    private int mAspectRatioX = GUIDELINES_ON_TOUCH;
    private int mAspectRatioY = GUIDELINES_ON_TOUCH;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (showGuidelines()) {
            if (this.mGuidelines == GUIDELINES_ON) {
                drawRuleOfThirdsGuidelines(canvas);
            } else if (this.mGuidelines == GUIDELINES_ON_TOUCH) {
    ...
    public void setGuidelines(int guidelines) {
        if (guidelines < 0 || guidelines > GUIDELINES_ON) {
    ...
    private void init(Context context) {
        ...
        this.mSnapRadius = TypedValue.applyDimension(GUIDELINES_ON_TOUCH, 6.0f, displayMetrics);
        ...
        this.mCornerOffset = TypedValue.applyDimension(GUIDELINES_ON_TOUCH, DEFAULT_CORNER_OFFSET_DP, displayMetrics);
        this.mCornerExtension = TypedValue.applyDimension(GUIDELINES_ON_TOUCH, DEFAULT_CORNER_EXTENSION_DP, displayMetrics);
        this.mCornerLength = TypedValue.applyDimension(GUIDELINES_ON_TOUCH, DEFAULT_CORNER_LENGTH_DP, displayMetrics);
        this.mGuidelines = GUIDELINES_ON_TOUCH;
    }
